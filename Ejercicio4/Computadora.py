class Computadora:
    ...
    def mostrar_informacion(self):
        ...
        print("Componentes: ")
        print(
            f"{'Componente':<15} {'Marca':<15} {'Cantidad':<15} {'Precio':<15} {'Subtotal':<15}"
        )
        for componente in self.componenteCPU:
            print(
                f"{componente.componente:<15} {componente.marca:<15} {componente.cantidad:<15} {componente.precio:<15} {componente.cantidad * componente.precio:<15}"
            )
